...
public class UsuarioBean implements UsuarioBeanRemote {
	...
	@Override
	public void modificarUsuario(Usuario usuario,  int estadoPK, int rolPK) throws ServiciosException {
		try {
			usuario.setEstado(em.find(EstadoUsuario.class, estadoPK));
			usuario.setRol(em.find(TipoUsuario.class, rolPK));
			em.merge(usuario);
			em.flush();
		} catch (PersistenceException e) {
	...
	@Override
	public Usuario findForMerge(int pk) throws ServiciosException {
		try {
