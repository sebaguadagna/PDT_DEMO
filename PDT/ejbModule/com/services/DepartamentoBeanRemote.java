...
public interface DepartamentoBeanRemote {
	...
	void altaDepartamento(Departamento nombre, Long zonaPK) throws ServiciosException;
	void bajaDepartamento(int pk) throws ServiciosException;
	void modificarDepartamentoZona(Departamento d, Long pkZona) throws ServiciosException;
