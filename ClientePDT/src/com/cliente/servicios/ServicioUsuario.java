...
public class ServicioUsuario {
	...
	public static void main(String[] args) throws NamingException, ServiciosException {
		...
		try {
			...
			user_m.setRol(TUsuarios.ADMINISTRADOR);
			usuarioBean.modificarUsuario(user_m);
			System.out.println("Se modifico exitosamente el usuario: " + user.getUsername());
			System.out.println("********************************************************");
		...
		try {
			...
			usuarioBean.modificarUsuario(user_m);
			System.out.println("Se bajo exitosamente el usuario: " + user.getUsername());
			System.out.println("********************************************************");
