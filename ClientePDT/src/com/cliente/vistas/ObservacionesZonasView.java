...
public class ObservacionesZonasView {
	...
	private void initialize() {
		...
		String columnas [] = {"PK_OBSERVACION", "DESCRIPCION",
				"FECHAHORA", "CATEGORIA", "DEPARTAMENTO", "LOCALIDAD", "USUARIO", "VALIDADO"};
			...
			public void mouseClicked(MouseEvent arg0) {
				try {
					...
					for (Observacion o : obsTabla.getQuery().obtenerPorZona((CZonas) comboBox.getSelectedItem())) {
						model.addRow(new Object[]{o.getPk_observacion().toString(), o.getDescripcion(), o.getFechaHora(), o.getCategoria().getNombre(),
								o.getDepartamento().getNombre(), o.getLocalidad().getNombre(), o.getUsr().getEmail(), o.isValidarExperto()});
					}
